...
spells.each do |spell|
  ...
  #now create a spell in the database using the data from this hash:
  Spell.create(
...
puts "DONE SEEDING!"
  # spell_hash["desc"] returns an array, so we need to 
  #access the first index to get just a string of the description